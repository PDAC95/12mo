...
SECRET_KEY = 'django-insecure-2#rc9tn391vsr=m*j_=63oez58v6hmt)8#tzr0#vil6mfw7pa3'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'spaces.context_processors.space_context',
            ],
        },
    },
]
...
# Authentication URLs for web interface
LOGIN_URL = '/login/'
